...
[![CRAN status](https://www.r-pkg.org/badges/version/sinterval)](https://CRAN.R-project.org/package=sinterval)
<!-- badges: end -->
...
You can install the released version of sinterval from [CRAN](https://CRAN.R-project.org) once it is up with:
...
Here is a basic example using [ggdist](https://mjskay.github.io/ggdist/) for visualization.
